...
public class LilLadyBingoEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LilLadyBingoEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LilLadyBingo/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LilLadyBingo/InitOutcome.xml").getDocumentElement();
